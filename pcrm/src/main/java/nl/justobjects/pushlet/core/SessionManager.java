...
public class SessionManager implements ConfigDefs {
	...
	public Session createSession(Event anEvent) throws PushletException {
		// Trivial
		//anEvent.setField("p_id", "a");
		//anEvent.setField("p_id", new Random().nextInt());
		
		return	Session.create(anEvent.getField(Subcriber.USERID));
		//	return Session.create(createSessionId());anEvent.getField("p_id", "visitor")
	}
